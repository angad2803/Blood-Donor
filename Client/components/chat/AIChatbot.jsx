...
const AIChatbot = ({ isOpen, onClose, user }) => {
  const [messages, setMessages] = useState([
    {
      ...
      type: "bot",
      message:
        "Hi! I'm your Blood Donation Assistant. How can I help you today?",
      timestamp: new Date(),
      quickReplies: [
        "How to donate blood?",
        "Find nearby donors",
  ...
  const getMockResponse = (userMessage) => {
    ...
    if (
      userMessage.toLowerCase().includes("blood group") ||
      userMessage.toLowerCase().includes("blood type")
    ) {
      return {
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs opacity-90">
                  {aiService.apiKey || aiService.geminiApiKey
                    ? "AI Powered"
                    : "Smart Assistant"}
                </p>
              </div>
